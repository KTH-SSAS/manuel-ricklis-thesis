...
class BaseGAT(nn.Module):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, concat=True, activation=nn.ELU(),
        ...
        self.linear_proj = nn.Linear(num_in_features, num_of_heads * num_out_features, bias=False).double()
        ...
        if add_skip_connection:
            self.skip_proj = nn.Linear(num_in_features, num_of_heads * num_out_features, bias=False).double()
        else:
