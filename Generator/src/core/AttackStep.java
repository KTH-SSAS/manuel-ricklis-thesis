...
public class AttackStep {
  // Attack steps are nodes in the attack graph
  // these are the required fields to work as such
  private final ArrayList<AttackStep> children = new ArrayList<>();
  private double value;

  public ArrayList<AttackStep> getChildren () {
    return this.children;
  }

  public void addChild (AttackStep child) {
    children.add(child);
  }
